const contractAddress = "0xB0385a34ed2c515b88F1553539393C53Ffe2601a"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Cool Red Cat Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Cool Red Cat Club is a collection of 5000 randomly generated and stylistically selected. Choose your red cat and join the no gaz frees live only on Polygon network.';
